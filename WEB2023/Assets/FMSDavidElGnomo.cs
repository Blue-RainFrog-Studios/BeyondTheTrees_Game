...
public class FMSDavidElGnomo : BehaviourRunner
{
    ...
    protected override BehaviourGraph CreateGraph()
    {
        FSM Gnomefsm = new FSM();
            ...
            //actions
            /**/ FunctionalAction WalkToPlayerAction = new FunctionalAction(_ActionsDavidElGnomo.UpdateMethodWalk); //estados que hay que meter
            /**/ FunctionalAction PunchAction = new FunctionalAction(_ActionsDavidElGnomo.UpdateMethodPunch); //estados que hay que meter
            ...
            /**/ StateTransition Punch_to_WalkingToPlayer = Gnomefsm.CreateTransition(Punch, WalkToPlayer, statusFlags: StatusFlags.Finished); // cambiara cuando se acabe la accion
